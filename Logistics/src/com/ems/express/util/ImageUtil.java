...
public class ImageUtil {
	...
	public static String comPressNewPath(String srcPath, String mark) {
		System.out.println("压缩前文件+++" + srcPath);
		...
		String newPath = FileUtil.getTempFileName(mark);

		try {
			FileOutputStream fos = new FileOutputStream(newPath);
			bitmap.compress(Bitmap.CompressFormat.JPEG, 100, fos);
			fos.close();
			System.out.println("压缩后文件+++" + newPath);
			return newPath;
		} catch (Exception e) {
			e.printStackTrace();
		}
