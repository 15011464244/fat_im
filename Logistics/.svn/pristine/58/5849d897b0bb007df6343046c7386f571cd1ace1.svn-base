...
//			App.dbHelper.addSender(App.db, senderInfo);
			...
			App.dbHelper.insertSenderMessage(App.db, "", "", SpfsUtil.loadPhone(), senderInfo.getType()+"", senderInfo.getName(), senderInfo.getPhone(), senderInfo.getProvCode(), senderInfo.getCityCode(), senderInfo.getCountyCode(), senderInfo.getLocation(), senderInfo.getProv(), senderInfo.getCity(), senderInfo.getCounty(), createDate, "");
...
//						}
	...
	private void editSender(PeopleInfo senderInfo,String phone){
		//开启菊花
		animationUtil.show();
		App.dbHelper.updateSenderMessage(App.db,senderInfo);
		HashMap<String, Object> json = new HashMap<String, Object>();
