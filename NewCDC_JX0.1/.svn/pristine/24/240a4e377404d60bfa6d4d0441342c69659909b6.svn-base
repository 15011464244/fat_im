...
/**
 * 
 * @author liunannan 更新于2015-6-26
 * 
 */
public class JXAsyncQueueService extends IntentService {
	private Handler mHandler;

	public JXAsyncQueueService() {
		super("aaa");
	}
	...
	protected void onHandleIntent(Intent intent) {
		if (Utils.isNetworkAvailable(getApplicationContext())) {
			...
			final QueueDao queueDao = DeliverDaoFactory.getInstance().getQueueDao(
