package com.newcdc.adapter.message;
...
public class PaymentAdapter extends BaseAdapter {
	...
	private List<ReceivePaymentBean> mList;
	private String messageIsSign = "2";
	private ViewHolder holder ;
	
	public PaymentAdapter(Context context,List<ReceivePaymentBean> list ) {
	...
	@Override
	public ReceivePaymentBean getItem(int position) {
...
//		}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ReceivePaymentBean bean = mList.get(index);
...
//			holder.isNotRead.setVisibility(View.VISIBLE);
	...
	private View hand7(Context mContext2, View convertView,
			ReceivePaymentBean bean, int index) {
...
//		holder.messageName.setText(Html.fromHtml("<font color=\'#858585\'>订单</font><font color=\'#f02387\'><U>购物咨询</U></font>"));
		holder.messageName.setText(Html.fromHtml("<font color=\'#858585\'>订单</font><font color=\'#ff9803\'>"+bean.getOrderNum()+"</font><font color=\'#858585\'>应付款</font><font color=\'#ff9803\'>"+bean.getPrice()+"</font><font color=\'#858585\'>元，付款成功</font>"));
...
//		LinearLayout paymentBody;
	...
	public void notifyData(List<ReceivePaymentBean> list){
		mList = list;
